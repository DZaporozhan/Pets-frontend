...
export const AddNoticeForm = ({onClose, addNotices}) => {
  ...
  const moveToNextPage = () => {isFirstPage
  ...
  return (
     <>
        ...
        <FormContent onSubmit={formik.handleSubmit}>
          ...
          <ActionButtons>
            {isFirstPage ? (<ActButton type="button" onClick={onClose}>Cancel</ActButton>)
              :
              (<ActButton type="button" onClick={moveToNextPage}>Back</ActButton>)
            }
            {isFirstPage ? (
              <ActButton type="button" onClick={moveToNextPage}> Next</ActButton>
            ) : (
